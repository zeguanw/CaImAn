...
# %%% MOTION CORRECTION
    ...
    if do_motion_correction:
        ...
        savefig(work_dir +'/outline/' + layer_name + '_motion-correct.pdf', bbox_inches='tight')
...
# %% SEGMENTATION
    ...
    if method == 'manual_annotation':                
        ...
        gui_ROIs = os.path.join(work_dir + '/roi/' + layer_name + '_roi.hdf5' )
        ...
        savefig(work_dir +'/outline/' + layer_name + '_roi_outline.pdf', bbox_inches='tight')
