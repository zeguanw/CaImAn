...
# %%% MOTION CORRECTION
    ...
    if do_motion_correction:
        ...
        savefig(trial_1_dir +'/auto/outline/' + layer_name + '_motion-correct.pdf', bbox_inches='tight')
...
# %% SEGMENTATION
    ...
    if method == 'maskrcnn':                 
        ...
        cm.movie(ROIs).save(trial_1_dir + '/auto/volpy_roi/' + layer_name + '_mrcnn_ROIs.hdf5')
...
# %% parameters for trace denoising and spike extraction
    ...
    min_spikes= 5                               # minimal spikes to be found
...
#vpy.estimates['t']
    ...
    sio.savemat(os.path.join(trial_1_dir + '/auto/matvars/T/T_' + layer_name + '.mat'), mdict={'T': vpy.estimates['t']})
    sio.savemat(os.path.join(trial_1_dir + '/auto/matvars/spikes/spikes_' + layer_name + '.mat'), mdict={'spikes': vpy.estimates['spikes']})
    sio.savemat(os.path.join(trial_1_dir + '/auto/matvars/threshold/thresh_' + layer_name + '.mat'), mdict={'thresh': vpy.estimates['thresh']})
    sio.savemat(os.path.join(trial_1_dir + '/auto/matvars/snr/snr_' + layer_name + '.mat'), mdict={'snr': vpy.estimates['snr']})
    sio.savemat(os.path.join(trial_1_dir + '/auto/matvars/t_sub/t_sub_' + layer_name + '.mat'), mdict={'t_sub': vpy.estimates['t_sub']})
    
    cm.movie(vpy.estimates['weights']).save(os.path.join(trial_1_dir + '/auto/matvars/weights/weights_' + layer_name + '.hdf5'))
